...
const merch = [
  {
    ...
    photos: [
      "assets/merch/caneca/brand-caneca-ordered-01.webp",
      "assets/merch/caneca/brand-caneca-ordered-02.webp",
      "assets/merch/caneca/brand-caneca-ordered-03.webp",
      "assets/merch/caneca/brand-caneca-ordered-04.webp",
    ],
  },
  {
    ...
    photos: [
      "assets/merch/hoodie/brand-hoodie-ordered-01.webp",
      "assets/merch/hoodie/brand-hoodie-ordered-02.webp",
      "assets/merch/hoodie/brand-hoodie-ordered-03.webp",
      "assets/merch/hoodie/brand-hoodie-ordered-04.webp",
    ],
  },
  {
    title: "Skeleton Guitar T-shirt",
    type: "T-shirts",
    price: "EUR 34",
    description: "T-shirt branca com detalhe coral e grafismo musical em preto.",
    photos: [
      "assets/merch/tshirt/brand-tshirt-skeleton-site-04.webp",
      "assets/merch/tshirt/brand-tshirt-skeleton-site-01.webp",
      "assets/merch/tshirt/brand-tshirt-skeleton-site-02.webp",
      "assets/merch/tshirt/brand-tshirt-skeleton-site-03.webp",
    ],
  },
  {
    title: "Sapatilhas Track Star",
    type: "Sapatilhas",
    price: "EUR 58",
    description: "Sapatilhas altas com detalhe coral e grafismo musical lateral.",
    photos: [
      "assets/merch/sapatilhas/brand-sapatilhas-wearer-01.webp",
      "assets/merch/sapatilhas/brand-sapatilhas-site-02.webp",
      "assets/merch/sapatilhas/brand-sapatilhas-site-04.webp",
      "assets/merch/sapatilhas/brand-sapatilhas-site-03.webp",
  ...
  },
  {
    ...
    photos: [
      "assets/merch/tote/brand-tote-ordered-01.webp",
      "assets/merch/tote/brand-tote-ordered-02.webp",
      "assets/merch/tote/brand-tote-ordered-03.webp",
      "assets/merch/tote/brand-tote-ordered-04.webp",
    ],
  },
];
...
const renderMerch = () => {
  ...
  container.classList.add("merch-carousel", "reveal");
  container.setAttribute("aria-label", "Produtos de merchandising");
  container.setAttribute("aria-roledescription", "carousel");

  const viewport = createElement("div", "merch-carousel-viewport");
  const track = createElement("div", "merch-carousel-track");
  const previousButton = createElement("button", "merch-carousel-button merch-carousel-button-prev", "‹");
  const nextButton = createElement("button", "merch-carousel-button merch-carousel-button-next", "›");

  previousButton.type = "button";
  previousButton.setAttribute("aria-label", "Produto anterior");
  nextButton.type = "button";
  nextButton.setAttribute("aria-label", "Produto seguinte");

  merch.forEach((item, index) => {
    const article = createElement("article", "merch-card merch-carousel-card");
  ...
  container.replaceChildren(viewport, previousButton, nextButton);
  ...
  const getMaxIndex = () => Math.max(0, merch.length - getVisibleCount());

  const updateCarousel = () => {
    const maxIndex = getMaxIndex();
    activeIndex = Math.min(activeIndex, maxIndex);
    const activeCard = track.children[activeIndex];
    track.style.transform = `translateX(-${activeCard?.offsetLeft || 0}px)`;
  };
  ...
  const startAutoplay = () => {
    stopAutoplay();
    if (reducedMotion.matches || merch.length <= getVisibleCount()) return;
    autoplayTimer = window.setInterval(() => goToProduct(activeIndex + 1), 5200);
  };
